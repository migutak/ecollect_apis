...
module.exports = function (Tblinvestigators) {
    Tblinvestigators.gridviewall = function (request, cb) {
        var ds = Tblinvestigators.dataSource;
    ...
    Tblinvestigators.remoteMethod('gridviewall', {
        accepts: [
            {
                arg: 'body',
                type: 'object',
    ...
    function buildSql(request) {
        ...
        const fromSql = ' from ecol.qalltblinvestigators ';
