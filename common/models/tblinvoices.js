...
module.exports = function(Tblinvoices) {

    Tblinvoices.gridviewall = function (request, cb) {
        var ds = Tblinvoices.dataSource;
      ...
      Tblinvoices.remoteMethod('gridviewall', {
        accepts: [
          {
            arg: 'body',
            type: 'object',
      ...
      function buildSql(request) {
        ...
        const fromSql = ' from ecol.tblinvoices ';
