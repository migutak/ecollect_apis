...
module.exports = function(Tblwriteoffs) {
    Tblwriteoffs.gridviewall = function (request, cb) {
        var ds = Tblwriteoffs.dataSource;
      ...
      Tblwriteoffs.remoteMethod('gridviewall', {
        accepts: [
          {
            arg: 'body',
            type: 'object',
      ...
      function buildSql(request) {
        ...
        const fromSql = ' from ecol.tbl_writeoffs ';
